...
public final class  InitializationComponent {
	...
	*
	*/
	public  Map<String, Object> initializationService( ) {
		...
		if (radarSimulator_simulateInitialClearance_initialClearance__initializationComponent_initializationService_initialClearance != null) {
		...
		if (speedSensor_generateSpeed_initialSpeed__initializationComponent_initializationService_initialSpeed != null) {
	...
	*/
	private void invokespeedSensor() {
		if (this.activeServiceName == "initializationService") {
			/* pull data from channels*/
