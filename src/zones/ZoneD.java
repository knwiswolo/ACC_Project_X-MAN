/**
 * this is implementation of composite component ZoneD  in Java
 */
...
public final class ZoneD {
	...
	public Float zoneD_service(Integer speedDifference, Float currentSpeed) {
		...
		System_zoneD_service_speedDifference__SEL_1_speedDifference = speedDifference; /*
																						 ...
																						 * channel
																						 */
		System_zoneD_service_currentSpeed__accelerator1_decelerate_currentSpeed = currentSpeed; /*
																								 * push
																								 * value
																								 * to
																								 * channel
																								 */
		System_zoneD_service_currentSpeed__accelerator2_accelerate_currentSpeed = currentSpeed; /*
																								 * push
																								 * value
																								 * to
																								 * channel
	...
	private void invokeSEL_1() {
		...
		if (System_zoneD_service_speedDifference__SEL_1_speedDifference != null) {
			speedDifference = System_zoneD_service_speedDifference__SEL_1_speedDifference;
			System_zoneD_service_speedDifference__SEL_1_speedDifference = null;
		}
	...
	private void invokeaccelerator1() {
		if (this.activeServiceName == "zoneD_service") {
			...
			if (System_zoneD_service_currentSpeed__accelerator1_decelerate_currentSpeed != null) {
				currentSpeed = System_zoneD_service_currentSpeed__accelerator1_decelerate_currentSpeed; /*
																										 * pull
																										 * value
																										 * from
																										 * channel
	...
	private void invokeaccelerator2() {
		if (this.activeServiceName == "zoneD_service") {
			/* pull data from channels */
			Float currentSpeed = null;
			if (System_zoneD_service_currentSpeed__accelerator2_accelerate_currentSpeed != null) {
				currentSpeed = System_zoneD_service_currentSpeed__accelerator2_accelerate_currentSpeed; /*
																										 * pull
																										 * value
																										 * from
																										 * channel
